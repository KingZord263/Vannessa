    ...
    const {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let md = "PARSLEY-XMD~" + string_session;
...
Thanks for choosing PARSLEY-XMD 1.0.0 🚩!

*You're one step ahead!* Join our WhatsApp Channel ⤵️ (https://chat.whatsapp.com/KoimPykML7mLoawSYZRjAl) and get exclusive updates!*
...
> *©  PARSLEY TECHNOLOGIES*`; 
                        await sock.sendMessage(sock.user.id, {
text: desc,
contextInfo: {
externalAdReply: {
title: "PARSLEY-XMD",
thumbnailUrl: "https://files.catbox.moe/rvm1iz.jpg",
sourceUrl: "https://files.catbox.moe/rvm1iz.jpg",
mediaType: 1,
